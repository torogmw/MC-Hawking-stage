...
var game = new Phaser.Game(375, 667, Phaser.CANVAS, 'target', {

    resize: function() {
      game.scale.scaleMode = Phaser.ScaleManager.USER_SCALE;
      game.scale.setUserScale(window.innerWidth / 375, window.innerHeight / 667, 0, 0);
      game.scale.refresh();
    ...
    init: function(){
        ...
        this.scale.maxWidth = 375;
        this.scale.maxHeight = 667;
        this.scale.pageAlignHorizontally = true;
        this.scale.pageAlignVertically = true;
        this.scale.updateLayout();
    },
    preload: function() {
      game.load.image('bg_dark','static/assets/background_dark.png');
      game.load.image('bg_light', 'static/assets/lightStage.png');
      game.load.spritesheet('button', 'static/assets/button.png', 216, 216);
      game.load.spritesheet('player', 'static/assets/player_move.png', 146, 211);
    },
    ...
    create: function(){
      ...
      this.lightBG.scale.setTo(0.5);

      this.player = game.add.sprite(game.world.centerX, game.world.centerY * 0.8, 'player');
      ...
      this.resize();
      this.myInput.canvasInput.onsubmit(this.resize);
      // this.myInput.canvasInput.onkeydown(this.resize);
      // this.myInput.canvasInput.onblur = this.resize();
      // this.myInput.canvasInput.onfocus = this.resize();
    },
  ...
  StopAnimation: function() {
      ...
      this.player.frame = 2;
      this.timer = game.time.events.add(Phaser.Timer.SECOND * 0.5, this.RestartAnimation, this);
  },
  ...
  RestartAnimation: function() {
    ...
    createInput: function(x, y){
        var bmd = this.add.bitmapData(287, 70);    
        var myInput = this.game.add.sprite(x, y, bmd);
        

        console.log(game.canvas.style.height);
        ...
        myInput.canvasInput = new CanvasInput({
              ...
              borderColor: '#000',
              borderRadius: 3,
              backgroundImage: 'static/assets/textField.png',
              backgroundColor: 'none',
              boxShadow: 'none',
              innerShadow: 'none',
              placeHolder: 'Yo!',
              placeHolderColor: '#062a10'
        });
...
(function() {
  ...
  var CanvasInput = window.CanvasInput = function(o) {
    ...
    self._hiddenInput.pattern = "[a-zA-Z]*";
    ...
    self._hiddenInput.style.fontSize = self._fontSize;
  ...
  CanvasInput.prototype = {
    ...
    keydown: function(e, self) {
      ...
      if((keyCode>=40&&keyCode < 65) || (keyCode>=91&&keyCode<=96)||(keyCode >122&&keyCode<126)||(keyCode>185)){
        e.preventDefault();
